...
class FormationsController < ApplicationController
  ...
  private
    ...
    def formation_params
      params.require(:formation).permit(:nom, :promo, :diplome, :domaine, :apprentissage, :memo, :nbr_etudiants, :nbr_heures,                                   :abrg, :user_id, :color, :Forfait_HETD, :Taux_TD, :Code_Analytique,
