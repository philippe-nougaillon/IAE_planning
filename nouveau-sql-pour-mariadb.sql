...
INSERT INTO `formations` VALUES(1,'MBA Marketing Communication et Santé','2016/2017','MBA','MARKETING COMMUNICATION ET SANTE','0','2016-12-08 09:41:32.395345','2016-12-19 15:34:05.019009','Examen le 12/03/2016',7);
INSERT INTO `formations` VALUES(4,'Master Management des Associations','2017','Master','','0','2016-12-19 10:08:57.482390','2016-12-19 11:21:36.022321','',20);
...
INSERT INTO `users` VALUES(3,'philippe.eynaud@univ-paris1.fr','$2a$10$nyzz6EAGHP75O5LfPcJq6OxebWI908/yUwCWwEvYXR5g8WKVoqUYu',NULL,NULL,NULL,2,'2016-12-22 10:20:00.530567','2016-12-22 09:17:00.848398','81.57.212.136','192.168.0.254','2016-12-22 06:00:46.792157','2016-12-22 16:34:20.716702','1',NULL,4);
INSERT INTO `users` VALUES(4,'dominique.riviere@univ-paris1.fr','$2a$10$zMUtxYuCatRww6hRXxfsOeJnPNKWXPe2qYENwXkMtQK4cUvXCmbne',NULL,NULL,NULL,1,'2016-12-22 10:42:34.482460','2016-12-22 10:42:34.482460','192.168.0.254','192.168.0.254','2016-12-22 06:03:44.193215','2016-12-22 10:42:34.483114','1',NULL,NULL);
INSERT INTO `users` VALUES(5,'hannah@gmail.com','$2a$10$YneZEelhCX8zJKslTy/O2efUuFkRLA9Zw53iW4O1AhVnsj5eGX6Xe',NULL,NULL,NULL,1,'2016-12-22 15:29:56.079048','2016-12-22 15:29:56.079048','192.168.0.254','192.168.0.254','2016-12-22 06:06:49.616357','2016-12-22 15:29:56.079880','0',NULL,4);
INSERT INTO `users` VALUES(6,'fitsch-mouras.iae@univ-paris1.fr','$2a$10$0pIPu10/jxPVWNzC9fFdTuNEdt/I3h2mEu7NCfqABbyKA0Kk72X06',NULL,NULL,NULL,1,'2016-12-22 11:29:58.520332','2016-12-22 11:29:58.520332','86.246.195.68','86.246.195.68','2016-12-22 10:41:19.835422','2016-12-22 11:29:58.521015','1',NULL,NULL);
CREATE TABLE `audits` (`id` INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, `auditable_id` integer, `auditable_type` varchar, `associated_id` integer, `associated_type` varchar, `user_id` integer, `user_type` varchar, `username` varchar, `action` varchar, `audited_changes` text, `version` integer DEFAULT 0, `comment` varchar, `remote_address` varchar, `request_uuid` varchar, `created_at` datetime);
...
CREATE TABLE `unites` (`id` INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, `formation_id` integer, `nom` varchar, `created_at` datetime NOT NULL, `updated_at` datetime NOT NULL, `num` varchar);
