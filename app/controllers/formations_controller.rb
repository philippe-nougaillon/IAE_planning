...
class FormationsController < ApplicationController
  ...
  private
    ...
    def formation_params
      params.require(:formation).permit(:nom, :promo, :diplome, :domaine, :apprentissage, :memo, :nbr_etudiants, :nbr_heures,                                   :abrg, :user_id, unites_attributes: [:id, :num, :nom, :_destroy])
    end
end
